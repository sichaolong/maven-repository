...
deployFunc(){
  ...
  cd $CURRENT_PATH
  # 开始deploy
  mvn clean deploy  -DaltDeploymentRepository=git@github.com:sichaolong/maven-repository.git::default::file:D:\\mysoftware_notinstall\\maven-3.9\\github-maven-repository\\repository
